let API = 'http://localhost:3000/api/v1'; // Por defecto

if (window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1') {
  // Si accedemos por red local o IP pública, resolvemos el backend dinámicamente
  API = `${window.location.protocol}//${window.location.hostname}:3000/api/v1`;
}
