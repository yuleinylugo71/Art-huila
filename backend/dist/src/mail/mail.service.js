...
let MailService = class MailService {
    ...
    constructor(configService) {
        ...
        this.fromEmail = this.configService.get('MAIL_USER');
    ...
    async sendOrderConfirmationEmail(to, name, orderId, total) {
        try {
            await this.transporter.sendMail({
                from: `"Art Huila" <${this.fromEmail}>`,
                to,
    ...
    async sendSaleNotificationEmail(to, artisanName, productName, quantity) {
        try {
            await this.transporter.sendMail({
                from: `"Art Huila" <${this.fromEmail}>`,
                to,
    ...
    async sendArtisanResponseEmail(to, buyerName, artisanName, productName) {
        try {
            await this.transporter.sendMail({
                from: `"Art Huila" <${this.fromEmail}>`,
                to,
