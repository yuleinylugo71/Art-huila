...
const mipaquete_service_1 = require("./mipaquete/mipaquete.service");
...
exports.LogisticsModule = LogisticsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [mipaquete_service_1.MipaqueteService],
        exports: [mipaquete_service_1.MipaqueteService],
    })
], LogisticsModule);
