      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:3rem;align-items:start;">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:0.5rem;margin-bottom:1.5rem;">
            <span id="header-stars" style="color:#f59e0b;"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i></span>
            <span id="header-count" style="font-size:0.85rem;color:var(--color-muted);font-weight:600;">(47 reseñas)</span>
          </div>
    ...
    <div class="mobile-only" style="background-color: #faf8f5; min-height: 80vh; padding: 0.5rem 1.25rem 5.5rem 1.25rem;">
      ...
      <div style="background: white; border-radius: 24px; border: 1.2px solid #e8e0d8; padding: 1.25rem; margin-bottom: 1.5rem; box-shadow: var(--shadow-xs);">
        ...
        <div style="display: flex; align-items: center; gap: 0.35rem; margin-bottom: 0.75rem;">
          <div style="display: flex; gap: 0.15rem; color: #f59e0b; font-size: 0.8rem;">
          ...
          <span style="font-size: 0.76rem; font-weight: 700; color: #261f1b;">4.9</span>
          <span style="font-size: 0.72rem; color: var(--color-muted); font-weight: 600;">(47 reseñas)</span>
        </div>
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; gap: 0.75rem;">
          <div style="display: flex; align-items: center; gap: 0.75rem;">
            <div style="position: relative; flex-shrink: 0;">
              ...
              <div style="position: absolute; bottom: 0; right: 0; width: 14px; height: 14px; border-radius: 50%; background: #c1440e; border: 1.5px solid white;"></div>
            </div>
            <div>
              <div style="font-size: 0.85rem; font-weight: 800; color: #261f1b; display: flex; align-items: center; gap: 0.25rem;">
                ${artisanName}
              </div>
